main:main.o Terminal.o doEcho.o fileProcess.o stringProcess.o doGrep.o doDiff.o doPwd.o doCp.o
	g++ main.o Terminal.o doEcho.o fileProcess.o stringProcess.o doGrep.o doDiff.o doPwd.o doCp.o -o main
